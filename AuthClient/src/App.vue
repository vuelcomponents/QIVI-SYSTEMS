...
import AppHeader from '@/components/referenced/headers/QuarxHeader.vue';
import QuarxFooter from '@/components/referenced/headers/QuarxFooter.vue';
...
import GokuSidebar from '@/components/referenced/panels/GokuSidebar.vue';
