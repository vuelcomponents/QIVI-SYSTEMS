...
const notifications = ref<Array<NotificationType>>(
  props.authService.storeHandler.userStore.user.notifications
);
...
<template>
  <main
    class="max-h-[400px] overflow-y-auto p-1 ring-1 ring-surface-400/20 dark:ring-surface-600 sm:max-h-screen"
  >
