export default {
  root: ({ state, props }) => ({
    class: [
      ...
      // Size
      { 'max-h-[90vh] lg:min-w-[80vw] min-w-[96vw]': props.modal },
  ...
  header: {
    class: [
      ...
      // Colors
      'bg-surface-0/0 dark:bg-surface-800',
  ...
  footer: {
    class: [
      ...
      // Colors
      'bg-surface-0/0 dark:bg-surface-700',
      'text-surface-700 dark:text-surface-0/80',
    ],
  },
  mask: ({ props }) => ({
    class: [
      ...
      {
        'has-[.mask-active]:bg-transparent dark:has-[.mask-active]:bg-transparent bg-surface-500/70 dark:bg-surface-700/70': true,
        'has-[.mask-active]:backdrop-blur-none backdrop-blur-sm': true,
      },
    ],
  }),
  transition: ({ props }) => {
