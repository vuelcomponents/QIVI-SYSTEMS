export default {
  ...
  sourcelist: {
    class: [
      ...
      'bg-surface-300/20 dark:bg-surface-800',
  ...
  item: ({ context }) => ({
    class: [
      ...
      { 'bg-surface-500/20 dark:bg-surface-600/30': context.active && !context.focused },
      { 'bg-surface-500/20 dark:bg-surface-500/30': context.active && context.focused },
      { 'bg-surface-500/20 dark:bg-surface-700/70': !context.active && context.focused },

      // State
      'hover:bg-surface-500/20 dark:hover:bg-surface-700',
