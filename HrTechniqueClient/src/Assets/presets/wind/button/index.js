export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Info Button
      {
        'text-surface-200 dark:text-surface-900':
          props.severity === 'info' && !props.text && !props.outlined && !props.plain,
        'bg-light-600 dark:bg-mintSplash-300':
          props.severity === 'info' && !props.text && !props.outlined && !props.plain,
        'dark:ring-blue-400':
          props.severity === 'info' && !props.text && !props.outlined && !props.plain,
        'hover:bg-primary-400 dark:hover:bg-mintSplash-400 ring-1 ring-surface-0/20 hover:ring-surface-0/20 hover:bg-light-700 ':
          props.severity === 'info',
      },
      // Info Text Button
      {
